...
<div class="contact-create">
    ...
    <br/>
    <h4><?= \Yii::t('app', 'اطلاعات تماس') ?></h4>
    <br/>
    <div class="contact-body">
        <ul class="contact-fields">
            <li>
                <span class="title"><?= \Yii::t('app', 'آدرس'); ?>:</span>
                <span class="value"> <?= $opts['address']; ?></span>
            </li>
            <li>
                <span class="title"><?= \Yii::t('app', 'تلفن'); ?>:</span>
                <span class="value"> <?= $opts['tel']; ?></span>
            </li>
            <?php if (isset($opts['email']) and !empty($opts['email'])) { ?>
                <li>
                    <span class="title"><?= \Yii::t('app', 'ایمیل'); ?>:</span>
            ...
            <?php if (isset($opts['telegram']) and !empty($opts['telegram'])) { ?>
                <li>
                    <span class="title"><?= \Yii::t('app', 'صفحه تلگرام'); ?>:</span>
                    <span class="value">
            ...
            <?php if (isset($opts['instagram']) and !empty($opts['instagram'])) { ?>
                <li>
                    <span class="title"><?= \Yii::t('app', 'صفحه اینستاگرام'); ?>:</span>
                    <span class="value">
            ...
            <?php if (isset($opts['gplus']) and !empty($opts['gplus'])) { ?>
                <li>
                    <span class="title"><?= \Yii::t('app', 'صفحه گوگل پلاس'); ?>:</span>
                    <span class="value">
            ...
            <?php if (isset($opts['facebook']) and !empty($opts['facebook'])) { ?>
                <li>
                    <span class="title"><?= \Yii::t('app', 'صفحه فیسبوک'); ?>:</span>
                    <span class="value">
            ...
            <?php if (isset($opts['twitter']) and !empty($opts['twitter'])) { ?>
                <li>
                    <span class="title"><?= \Yii::t('app', 'صفحه تویتر'); ?>:</span>
                    <span class="value">
            ...
            <?php if (isset($opts['aparat']) and !empty($opts['aparat'])) { ?>
                <li>
                    <span class="title"><?= \Yii::t('app', 'صفحه آپارات'); ?>:</span>
                    <span class="value">
            ...
            <?php if (isset($opts['youtube']) and !empty($opts['youtube'])) { ?>
                <li>
                    <span class="title"><?= \Yii::t('app', 'صفحه یوتیوب'); ?>:</span>
                    <span class="value">
